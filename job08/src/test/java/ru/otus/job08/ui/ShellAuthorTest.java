...
public class ShellAuthorTest {
    ...
    public void addOkTest() {
        ...
        author.setId("10");
        when(mockRepository.save(any())).thenReturn(author);
       // Команда (длинная)
        ...
        assertEquals(new Author("Иван", "Хлестаков"), captor.getValue());
    }
    ...
    public void addExceptionTest() {
        ...
        ArgumentCaptor<Author> captor = ArgumentCaptor.forClass(Author.class);
        verify(mockRepository).save(captor.capture());
        assertEquals(new Author("Имя", "Фамилия"), captor.getValue());
    }
    ...
    public void updateOkTest() {
       ...
       // Команда (длинная) удалить запись с ID = 100. Возвращает пользователю ОК.
        ...
        ArgumentCaptor<Author> captor = ArgumentCaptor.forClass(Author.class);
        verify(mockRepository).save(captor.capture());
        Author author = new Author("Павел", "Чичиков");
        author.setId("22");
    ...
    public void deleteOkTest() {
        // Repository возвращает существующий объект.
        when(mockRepository.findById(any())).thenReturn(Optional.of(new Author()));
        // Команда (длинная) удалить запись с ID = 100. Возвращает пользователю ОК.
