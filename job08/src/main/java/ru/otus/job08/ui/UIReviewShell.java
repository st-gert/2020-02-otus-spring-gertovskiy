...
public class UIReviewShell {
    ...
    public String addGenre(
            @ShellOption(value = "-id", help = "ID книги.") String bookId,
            @ShellOption(value = "-r", help = "Отзыв на книгу.") String opinion) {
        return shellUtil.getMessageFromString(controller.addReview(bookId, opinion));
    }

    @ShellMethod(value = "Изменить отзыв.", key = {"review-update", "ru"})
    public String updateGenre(
            @ShellOption(value = "-id", help = "ID отзыва.") String id,
