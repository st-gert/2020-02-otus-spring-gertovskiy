...
import ru.otus.job09.model.dto.BookDto;
...
class BookListControllerTest {
    ...
    void getGenreForBookList() throws Exception {
        ...
        MvcResult result = mvc.perform(get("/book/genre"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("text/html;charset=UTF-8"))
                .andReturn();
        String content = result.getResponse().getContentAsString();
    ...
    void listBooksByGenre() throws Exception {
        ...
        MvcResult result = mvc.perform(post("/book/genre")
    ...
    void getAuthorsForBookList() throws Exception {
        ...
        MvcResult result = mvc.perform(get("/book/authors"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("text/html;charset=UTF-8"))
                .andReturn();
        String content = result.getResponse().getContentAsString();
    ...
    void listBooksByAuthors() throws Exception {
        ...
        MvcResult result = mvc.perform(post("/book/authors")
